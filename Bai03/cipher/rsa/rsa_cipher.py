...
from ui.rsa import Ui_MainWindow  # Sửa thành Ui_MainWindow
import requests
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                # Giả sử key JSON từ API là "encrypted_message"
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                # Giả sử key JSON từ API là "decrypted_message"
    ...
    def call_api_sign(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                # Giả sử key JSON từ API là "signature"
